      ...
      <div className="w-full max-w-6xl">
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {cards.map(({ index }) => (
            <article
              key={index}
              className="group relative bg-white rounded-[12px] border-2 border-transparent hover:border-[#3347af] transition-all duration-300 ease-out flex flex-col justify-between w-full min-h-[265px] px-5 py-5 md:w-[388px] md:h-[290px] md:px-8 md:py-7"
              ...
              <div className="flex justify-between gap-3 md:gap-4 h-full">
                <div className="flex-1 flex flex-col min-w-0">
                  ...
                  <h2 className="text-[18px] leading-[24px] font-semibold text-[#1b2838] mb-2 md:text-[20px] md:leading-[26px] md:mb-3 md:max-w-[210px]">
                    {index === 4 ? (
                      "ESOP, SAR and Equity Instrument Valuation"
                    ) : index === 1 ? (
                      "Complex Securities & Instruments"
                    ) : index === 2 ? (
                      "Merger and Swap Ratio Valuation"
                    ) : index === 3 ? (
                      <>
                        Portfolio
                        <br />
                      ...
                      "Litigation Disputes and Specialist Valuation"
                    ) : index === 7 ? (
                      "IPR Valuation"
                    ) : index === 8 ? (
                      <>
                        Cross-border Transaction and
                        <br />
                  ...
                  <ul className="list-disc list-outside pl-5 space-y-0.5 md:space-y-1 text-[14px] leading-[20px] md:text-[15px] md:leading-[22px] text-[#5b6575]">
                    {index === 1 ? (
                      <>
                        <li>Convertibles</li>
                        <li>Warrants</li>
                      ...
                      <>
                        ...
                        <li>Family Office Investments</li>
                      </>
                    ) : index === 4 ? (
                      <>
                        <li>Stock Options</li>
                        <li>Stock Appreciation Rights</li>
                        <li>Performance Linked Incentive Plans</li>
                        <li>Phantom Equity</li>
                      </>
                    ) : index === 5 ? (
                      <>
                        <li>Estate and Gift Tax Valuation</li>
                        <li>Qualified Appraisal for IRS</li>
                        <li>Section 2701 &amp; 409A Valuations</li>
                      ...
                      <>
                        <li>Valuation for Market Regulators (SEBI, SEC)</li>
                        <li>Foreign Exchange Laws</li>
                      ...
                      <>
                        ...
                        <li>Tangible Asset Valuations</li>
                      </>
                    )}
                  </ul>
                </div>
              ...
              <div className="flex flex-col md:flex-row min-h-0 flex-1 overflow-hidden md:overflow-y-auto">
                <div className="md:w-2/5 w-full relative flex flex-col items-center justify-center pt-14 pb-8 md:py-20 shrink-0 min-h-[220px] md:min-h-0 bg-[#0b3b84] md:bg-transparent">
                  <img
                    ...
                    alt="Card icon large"
                    className="w-[90px] h-[90px] md:w-[138px] md:h-[138px] object-contain drop-shadow-[0_12px_24px_rgba(0,0,0,0.22)]"
                  />
                </div>
                ...
                <div className="md:w-3/5 w-full bg-[#ffffff] text-[#1b2838] px-5 py-6 md:px-10 md:py-12 overflow-y-auto min-h-0 flex-1 min-w-0">
                  ...
                  <h2 className="text-[22px] leading-[28px] font-semibold mb-3 md:text-[32px] md:leading-[40px] md:mb-4 text-[#12213a]">
                    {activeCardIndex === 1
                      ...
                      ? "ESOP, SAR and Equity Instrument Valuation"
                      : activeCardIndex === 5
                      ? "Regulatory and tax valuation"
                      : activeCardIndex === 6
                      ? "Litigation Disputes and Specialist Valuation"
                      : activeCardIndex === 7
                      ? "IPR Valuation"
                      : activeCardIndex === 8
                      ? "Cross-border Transaction and Regulatory Valuation"
                      : "Financial Reporting Valuation"}
                  </h2>

                  <p className="text-[14px] md:text-[16px] text-[#42506a] mb-3 md:mb-4 font-medium">
                    {activeCardIndex === 1
                      ? "Convertibles, Warrants, Derivatives, Carried Interest"
                      : activeCardIndex === 2
                      ? "Merger Valuation, Swap Ratio Analysis, Fairness Opinions"
                      : activeCardIndex === 3
                      ? "PE/VC Portfolio, Credit Portfolios, Alternative Assets, Family Office Investments"
                      : activeCardIndex === 4
                      ? "Stock Options, Stock Appreciation Rights, Performance Linked Incentive Plans, Phantom Equity"
                      : activeCardIndex === 5
                      ? "Estate and Gift Tax Valuation, Qualified Appraisal for IRS, Section 2701 & 409A Valuations, Tax Triggered Events"
                      : activeCardIndex === 6
                      ? "Commercial Disputes, Insolvency, Expert Witness, IP Infringement"
                      : activeCardIndex === 7
                      ? "Licenses, Franchises, Brand/Trademarks, Copyright, Domain Names, Digital Assets"
                      : activeCardIndex === 8
                      ? "Valuation for Market Regulators (SEBI, SEC), Foreign Exchange Laws, Multi-Jurisdictional Compliance"
                      : "Purchase Price Allocation · Goodwill & Impairment Testing · Fair Value Measurement · Tangible Asset Valuations"}
                  </p>

                  <p className="text-[14px] leading-[22px] md:text-[16px] md:leading-[24px] text-[#5b6575]">
                    {activeCardIndex === 1
                      ? "Expert in pricing non-vanilla and exotic instruments by blending quantitative theory with market intuition. Proficient in deploying Monte Carlo simulations and advanced pricing models where standard frameworks fail."
                      : activeCardIndex === 2
                      ...
                      : activeCardIndex === 5
                      ? "Valuation structure for wealth transfers and for relevant compliance under Income Tax Acts, including IRS."
                      : activeCardIndex === 6
                      ? "Valuation evidence built to withstand scrutiny in courts, arbitration, and regulatory proceedings for Damage Quantification, Loss of Profit Assessments."
                      : activeCardIndex === 7
                      ? "Integrated assessment and valuation of IP by measuring the demand potential and an assessment of market viability."
                      : activeCardIndex === 8
                      ? "Delivering comprehensive valuations for complex inbound and outbound M&A. We adopt diverse valuation standards across geographies to ensure seamless compliance with simultaneous regulatory, tax, and financial reporting requirements."
                      : "We support audit committees, finance teams, and top tier auditors with our technically rigorous valuations that are in compliance with Ind AS, IFRS, and US GAAP requirements."}
                  </p>
                </div>
              </div>
            </div>
